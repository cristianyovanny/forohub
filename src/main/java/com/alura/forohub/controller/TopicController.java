...
public class TopicController {
    ...
    private com.alejobeliz.proyectos.forohub.service.TopicService service;

    @Autowired
    public TopicController(com.alejobeliz.proyectos.forohub.service.TopicService service) {
